...
var internalFormatFuncs = map[Locale]internalFormatFunc{
	...
	LocaleCsCZ:        createCommonFormatFuncWithGenitive(LocaleCsCZ),
	LocaleCsCZNoDia:   createCommonFormatFunc(LocaleCsCZNoDia),
	LocaleCsCZParadox: createCommonFormatFunc(LocaleCsCZParadox),
}
...
var internalParseFuncs = map[Locale]internalParseFunc{
	...
	LocaleCsCZ:        createCommonParsetFuncWithGenitive(LocaleCsCZ),
	LocaleCsCZNoDia:   createCommonParseFunc(LocaleCsCZNoDia),
	LocaleCsCZParadox: createCommonParseFunc(LocaleCsCZParadox),
}
...
func fillKnownWords() {
	...
	// Cs_CZNoDia: Czech Without Diacritics (Czech Republic)
	fillKnownDaysLong(longDayNamesCsCZNoDia, LocaleCsCZNoDia)
	fillKnownDaysShort(shortDayNamesCsCZNoDia, LocaleCsCZNoDia)
	fillKnownMonthsLong(longMonthNamesCsCZNoDia, LocaleCsCZNoDia)
	fillKnownMonthsShort(shortMonthNamesCsCZNoDia, LocaleCsCZNoDia)

	// Cs_CZParadox: Czech Paradox (Czech Republic)
	fillKnownDaysLong(longDayNamesCsCZParadox, LocaleCsCZParadox)
	fillKnownDaysShort(shortDayNamesCsCZParadox, LocaleCsCZParadox)
	fillKnownMonthsLong(longMonthNamesCsCZParadox, LocaleCsCZParadox)
	fillKnownMonthsShort(shortMonthNamesCsCZParadox, LocaleCsCZParadox)
}
